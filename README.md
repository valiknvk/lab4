...
https://github.com/SatsunkevichAlex/nns/blob/main/lab4. Прикреплены Txt файл с логом и pdf с результатами. Запуск на 42к изображений на 11 эпохах (до прерывания обучения).
